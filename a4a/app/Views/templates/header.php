...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <a class="btn btn-outline btn-primary" href="/clientInbox" role="button"> <i
    ...
    <div class="l-navbar" id="nav-bar">
        ...
        <nav class="nav">
            <div>
                ...
                <?php if($role == "client") : ?>
                    <div class="nav_list">
                    <a href="<?= base_url() ?>/clientPortal" class="nav_link <?= ($activePage == "clientPortal" ? "active" : "") ?>">
                        <i class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Dashboard</span>
                    </a>

                    <a href="<?= base_url() ?>/createTemplate" class="nav_link <?= ($activePage == "createTemplate" ? "active" : "") ?>">
                        <i class='bx bx-list-ul nav_icon'></i>
                        <span class="nav_name">Create Template(s)</span>
                    </a>

                    <a href="<?= base_url() ?>/deleteTemplate" class="nav_link <?= ($activePage == "deleteTemplate" ? "active" : "") ?>">
                        <i class='bx bx-trash nav_icon'></i>
                        <span class="nav_name">Delete Template(s)</span>
                    </a>

                    <a href="<?= base_url() ?>/clientInbox" class="nav_link <?= ($activePage == "clientInbox" ? "active" : "") ?>">
                        <i class='bx bx-envelope nav_icon'></i>
                        <span class="nav_name">View Inbox</span>
                    </a>

                    <a href="<?= base_url() ?>/clientSettings" class="nav_link <?= ($activePage == "clientSettings" ? "active" : "") ?>">
                ...
                <?php if($role == "customer") : ?>
                    ...
                    <a href="<?= base_url() ?>/customerPortal" class="nav_link <?= ($activePage == "customerPortal" ? "active" : "") ?>">
                        <i class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Dashboard</span>
                    </a>
