...
-- Dumping data for table ci_app.audit_template: ~1 rows (approximately)
...
INSERT INTO `company` (`id`, `email`, `username`, `password`, `companyName`, `companyNumber`) VALUES
	...
	(7, 'karl@karl.com', 'karl', 'karl', 'karl', 'karl');
...
-- Dumping data for table ci_app.company_audit: ~1 rows (approximately)
...
INSERT INTO `sys_users` (`id`, `name`, `password`, `avatar`, `email`, `role`, `date_created`, `company_id`, `last_login`, `user_preferences`, `company_type`) VALUES
	...
	(3, 'karl', 'karl', '', 'karl@karl.com', '', '0000-00-00 00:00:00', '', NULL, NULL, 'customer');
