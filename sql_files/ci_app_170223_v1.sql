...
-- Dumping data for table ci_app.audit_questions: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `companyName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `companyNumber` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
INSERT INTO `company` (`id`, `email`, `contact`, `tel`, `companyName`, `companyNumber`, `address`, `companyType`, `date_created`) VALUES
	(1, 'wimpole@test.com', 'Polly Ingham-Watts', '0207XXXXXX', 'Wimpole Hall', 'test', 'Wimpole Estate, Arrington, Royston SG8 0BW', NULL, '2023-02-17 10:26:39'),
	(2, 'oxford@test.com', 'Sarah Smith', '0207XXXXXX', 'Oxford Bus Museum ', 'test', 'Oxford Bus Museum & Morris Motors Museum', NULL, '2023-02-17 10:26:52'),
	(10, 'john.beer@test.com', 'John Beer', '0207XXXXXX', 'Sheffield Water Works Company (Wetherspoons)', NULL, '2-12 Division Street, S1 4GF', 'Pub', '2023-02-17 10:18:34'),
	(11, 'steven.doctor@test.com', 'Steven Doctor', '0207XXXXXX', 'Northern General Hospital', NULL, 'Herries Road, S5 7AU', 'Hospital', '2023-02-17 10:18:34'),
	(12, 'amelia.pyramid@test.com', 'Amelia Pyramid', '0207XXXXXX', 'Weston Park Museum', NULL, 'Weston Bank, S10 2TP', 'Museum', '2023-02-17 10:18:34'),
	(13, 'sarah.json@test.com', 'Sarah Johnson', '0207XXXXXX', 'Tropical Butterfly House', NULL, 'Woodsetts Road, S25 4EQ', 'Tourist Attraction', '2023-02-17 10:18:34'),
	(14, 'david.chen@test.com', 'David Chen', '0207XXXXXX', 'Sheffield Botanical Gardens', NULL, 'Clarkehouse Road, S10 2LN', 'Tourist Attraction', '2023-02-17 10:18:34'),
	(15, 'john.lee@test.com', 'John Lee', '0207XXXXXX', 'National Emergency Services Museum', NULL, '101-109 West Bar, S3 8PT', 'Museum', '2023-02-17 10:18:34'),
	(16, 'mick.marriott@test.com', 'Mick Marriott', '0207XXXXXX', 'Sheffield Hallam University', NULL, 'Hallam Square, S1 2LX', 'University', '2023-02-17 10:18:34'),
	(17, 'michael.davis@test.com', 'Michael Davis', '0207XXXXXX', 'Crucible Theatre', NULL, '55 Norfolk Street, S1 1DA', 'Entertainment', '2023-02-17 10:18:34'),
	(18, 'jane.smith@test.com', 'Jane Smith', '0207XXXXXX', 'Meadowhall Centre', NULL, 'Meadowhall Center S9 1EP', 'Shopping Center', '2023-02-17 10:18:34');
...
INSERT INTO `company_audit_response` (`id`, `question_id`, `audit_id`, `response`, `auditor`, `notes`, `date_created`, `last_updated`) VALUES
	...
	(2032, 132, 22, 1, NULL, '', '2023-02-16 22:31:18', NULL),
...
-- Dumping data for table ci_app.question_bank: ~0 rows (approximately)
...
-- Dumping data for table ci_app.sys_users: ~0 rows (approximately)
...
INSERT INTO `sys_users` (`id`, `name`, `password`, `avatar`, `email`, `role`, `date_created`, `company_id`, `last_login`, `user_preferences`, `company_type`) VALUES
	(1, 'Jane Cooper', 'Test1234', 'Jane-2.jpg', 'jane@test.com', '1', '2023-02-15 11:04:33', 1, NULL, NULL, 'client'),
