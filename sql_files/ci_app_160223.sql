...
-- Dumping data for table ci_app.company: ~2 rows (approximately)
...
-- Dumping data for table ci_app.company_audit_response: ~102 rows (approximately)
...
INSERT INTO `company_audit_response` (`id`, `question_id`, `audit_id`, `response`, `auditor`, `notes`, `date_created`, `last_updated`) VALUES
	...
	(1932, 57, 21, NULL, NULL, NULL, '2023-02-15 11:56:05', NULL),
...
-- Dumping data for table ci_app.sys_users: ~2 rows (approximately)
...
INSERT INTO `sys_users` (`id`, `name`, `password`, `avatar`, `email`, `role`, `date_created`, `company_id`, `last_login`, `user_preferences`, `company_type`) VALUES
	(1, 'client', 'Test1234', 'avatar', 'client_user@domain.com', '1', '2023-02-15 11:04:33', NULL, NULL, NULL, 'client'),
	(2, 'customer', 'Test1234', 'avatar', 'customer_user@domain.com', '1', '2023-02-15 11:04:33', NULL, NULL, NULL, 'customer'),
	(5, 'asdasd', 'asdasd', '', 'asdasd@123.com', '', '2023-02-15 11:47:41', 9, NULL, NULL, 'customer');
